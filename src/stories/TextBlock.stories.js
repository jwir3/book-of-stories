...
export const Default = {
  args: {
    ...
    paragraphs: [
      "There was a time when I was not quite as mentally stable as I am now. In fact, it could be said I was quite unstable. The reality, of course, was that I didn't believe myself to be either stable or unstable. I didn't actually give the stability of my mind any thought, which, as I have found out, isn't that normal.",
